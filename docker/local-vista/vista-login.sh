#!/bin/bash
# VistA roll-and-scroll terminal login shell
# Keep runtime identity explicit so the Kernel banner is understandable.
...
export gtm_etrap='W !,$ZSTATUS,!! HALT'

patch_yottadb_terminal_routines() {
	local routine_dir="/opt/vista/r"
	local changed=0
