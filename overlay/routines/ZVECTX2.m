...
RUN ;
 ...
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE USMG VCCHECK")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE USMG VCHIST")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE USER CLONE")
 ;
 ; Authentication RPCs (ZVEAUTH.m)
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE AUTH EMAILOOKUP")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE AUTH RESETGEN")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE AUTH RESETVAL")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE AUTH RESETEXEC")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE AUTH VCVERIFY")
 ;
