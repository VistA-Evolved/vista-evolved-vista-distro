...
LIST2(R,SEARCH,STATUS,DIVISION,MAX) ;
 ...
 N IEN,NM,CNT,MAXR,DISUSER,TITLE,SVC,LASTLOG,KCNT,DIVNM,DIVMATCH,DIEN,OUT
 S CNT=0
 ...
 . . N STAT S STAT=$S(DISUSER]"":"INACTIVE",TERMDT]"":"TERMINATED",1:"ACTIVE")
 ...
 . . S CNT=CNT+1
 . . S OUT(CNT)=IEN_U_NM_U_STAT_U_TITLE_U_SVC_U_DIVNM_U_LASTLOG_U_KCNT
 ;
...
DETAIL(R,TARGETDUZ) ;
 ...
 S STAT=$S(DISUSER]"":"INACTIVE",1:"ACTIVE")
