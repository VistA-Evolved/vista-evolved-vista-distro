...
INSTALL ;
 ...
 ;   Line 2+: "IEN^NAME^STATUS^TITLE^SERVICE^DIVISION^LASTLOGIN^KEYCOUNT^ISPROVIDER^EMPID^EMAIL"
 ; ============================================================
LIST2(R,SEARCH,STATUS,DIVISION,MAX,FROM,PAGED) ;
 ; List users from NEW PERSON #200 — collects into array, writes header first
 N IEN,NM,COLLECTED,MAXR,DISUSER,TITLE,SVC,LASTLOG,KCNT,DIVNM,DIVMATCH,DIEN,OUT,ISPROV,EMPID,EMAIL
 ...
 . . S EMPID=$G(^ZVEX(IEN,"EMPID"))
 . . S EMAIL=$$GET1^DIQ(200,IEN_",",.151,"E")
 . . S OUT(COLLECTED)=IEN_U_NM_U_STAT_U_TITLE_U_SVC_U_DIVNM_U_LASTLOG_U_KCNT_U_ISPROV_U_EMPID_U_EMAIL
 ;
...
DETAIL(R,TARGETDUZ) ;
 ...
 N COSIGNER S COSIGNER=$$GET1^DIQ(200,TARGETDUZ_",",53.8,"E")
 ;
 ...
 N KIEN,KNAME,KKIEN,KIENS,RAW,KADATE
 ...
 . S KADATE=$$GET1^DIQ(200.051,KIENS,3,"I")
 . I KNAME="" D
 . . S RAW=$P($G(^VA(200,TARGETDUZ,51,KIEN,0)),U,1)
 . . I RAW="" Q
 . . S KNAME=RAW
 . . S KKIEN=$O(^DIC(19.1,"B",RAW,0))
 . I KADATE="" S KADATE=$P($G(^VA(200,TARGETDUZ,51,KIEN,0)),U,3)
 . I KNAME="" Q
 . S LN=LN+1,R(LN)="KEY"_U_$G(KKIEN)_U_KNAME_U_$G(KADATE)
 ;
 ; Divisions
...
EDIT(R,TARGETDUZ,FIELD,VALUE) ;
 ...
 E  I FIELD="HOME_PHONE" S FNUM=.131
 E  I FIELD="VOICE PAGER" S FNUM=.133
 E  I FIELD="DIGITAL PAGER" S FNUM=.134
 ...
 E  I FIELD="COSIGNER" S FNUM=53.8
 E  I FIELD="DEGREE" S FNUM=10.6
 E  I FIELD="MENU" S FNUM=201
 E  I FIELD="OERR" S FNUM=200.0001
 E  I FIELD="INITIALS" S FNUM=20.2
 E  I FIELD="SIG BLOCK" S FNUM=20.3
 E  I FIELD="ESIG" S FNUM=20.4
 E  I FIELD="TREATING_SPEC" S FNUM=29.5
